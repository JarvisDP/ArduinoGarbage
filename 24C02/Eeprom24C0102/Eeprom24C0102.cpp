...
/**************************************************************************//**
 * \fn Eeprom24C0102::Eeprom24C0102(byte deviceAddress)
 *
 * \brief Constructor.
 *
 * \param   deviceAddress   EEPROM address on TWI bus.
 ******************************************************************************/
Eeprom24C0102::Eeprom24C0102
(
    byte deviceAddress
){
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::initialize()
 *
 ...
 ******************************************************************************/
void
Eeprom24C0102::initialize()
{
    Wire.begin();
}

/**************************************************************************//**
 * \fn void Eeprom24C0102::writeByte(
 * byte address,
 * byte data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::writeBytes(
 * byte     address,
 * byte     length,
 * byte*    p_data)
 * 
...
/**************************************************************************//**
 * \fn byte Eeprom24C0102::readByte(byte address)
 * 
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::readBytes(
 * byte     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::writePage(
 * byte     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::writeBuffer(
 * byte     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C0102::readBuffer(
 * byte     address,
 * byte     length,
 * byte*    p_data)
 *
